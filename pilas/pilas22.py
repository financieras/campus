...
def establece_lis():   # esta función solo se debería invocar una vez. Proporciona una matriz con listas de posibles lis
...
if __name__ == "__main__":    
    ...
    for i in range(100000):
        ...
        posibles_lis = establece_lis()   # llama a la función que proporciona una matriz con las posibles lis de dos o tres números de la pila A
        while True:
            a = a_original[:]
            b = []
